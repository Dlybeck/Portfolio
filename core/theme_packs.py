...
BOARD_PRESENTATION_TOKENS = frozenset(
    {
        ...
        "viewer-exit-duration", "viewer-handoff-enter-duration",
        "viewer-handoff-exit-duration", "cover-enter-easing", "cover-exit-easing",
...
DOCUMENT_PRESENTATION_TOKENS = frozenset(
    {
        ...
        "title-size", "title-line-height", "title-ink", "body-line-height", "title-weight",
        "heading-weight",
