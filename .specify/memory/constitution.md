...
✅ plan-template.md - Constitution Check section will be updated with 6 gates
✅ spec-template.md - Requirements section will ensure security/observability/DRY
✅ tasks-template.md - Task categories will include tests, logging, docs, security, refactoring
...
**Rationale**: As a solo developer maintaining a public-facing app, code clarity
directly impacts velocity and reduces the risk of introducing bugs during changes.
...
OpenCode AI) requires defense in depth. Single security failure exposes entire dev
environment.
...
- **Proxy**: SOCKS5 for secure server access
...
- Cloud Run auto-deploys on `main` branch push (per AGENTS.md)
